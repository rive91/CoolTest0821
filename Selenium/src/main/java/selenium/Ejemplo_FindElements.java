...
public class Ejemplo_FindElements {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Numero de Menus: " + firstLevelMenu.size()); // size() un metodo de java para ver el numero de elementos en la lista

		String primerMenu = firstLevelMenu.get(0).getText();
		String segundoMenu = firstLevelMenu.get(1).getText();
		
		System.out.println(primerMenu + " " +segundoMenu);
